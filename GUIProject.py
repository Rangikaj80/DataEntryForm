...
def enter_data():
    ...
    # Determine if the script is being run as a bundled executable or a script
    if getattr(sys, 'frozen', False):
    # If bundled as an executable by PyInstaller
       db_path = os.path.join(sys._MEIPASS, 'data.db')
    else:
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            # filepath = "C:\\Users\DELL\\source\\repos\\GUIProject\\data.xlsx"
           ...
           # Create Table
            ...
            data_insert_tuple = (firstname,lastname,title,age,
                                nationality, registration_status, numcourses, numsemesters)
            cursor = conn.cursor()
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["India","Pakistan","Sri Lanka","Bangaladesh","Nepal","Other"] )
